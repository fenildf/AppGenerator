...
public class CommonUtils {
	...
	public void main() {
		...
		//根据安装apk的包名获取安装包信息
		PackageUtil.getPackageInfoByPackageName(BaseApplication.getInstance(), "com.gjfax.app");
		...
		//获取apk的签名
		PackageUtil.getSign(BaseApplication.getInstance(), "com.gjfax.app");
		...
		//根据包名启动app
		PackageUtil.startAppByPackageName(BaseApplication.getInstance(), "com.gjfax.app");
		
		//卸载app
		PackageUtil.uninstallApk(BaseApplication.getInstance(), "com.gjfax.app");
		
		//////////////////////////////其他工具类
		
		//url编码
		Utility.parseUrl("http://www.gjfax.com?param=aaa");
		
		//url解码
		Utility.decodeUrl("http://www.gjfax.com");
