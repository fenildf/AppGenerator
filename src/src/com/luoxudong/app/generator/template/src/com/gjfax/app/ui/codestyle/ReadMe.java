 ...
 * Version: 1.0
 */
package com.gjfax.app.ui.codestyle;
...
/**
 * 介绍：
 * APP使用MVC三层架构设计，数据访问层代码在com.gjfax.app.logic.db包下，参考UserInfoDao，
 * 控制层按模块划分，在com.gjfax.app.logic包下，参照com.gjfax.app.logic.user，
 * UI层代码在com.gjfax.app.ui包下。logic包中的代码不能出现UI控件方面的类，如：View，com.gjfax.app.R等，
 * 可通过Context链接UI层跟控制层。
 * 
 * 主要基础库：
 ...
 * 9、http传输实现参考com.gjfax.app.logic.user.manager.UserManager中的loginRequest()类
 * 
 * 
 * 
 * 
