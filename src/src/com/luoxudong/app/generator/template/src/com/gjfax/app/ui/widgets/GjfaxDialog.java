...
public class GjfaxDialog extends Dialog {
	...
	public GjfaxDialog(Context context, int theme) {
		super(context, theme);
	}

	protected GjfaxDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
	...
	public static class Builder {
		 ...
		 * 创建视图
		 */
		public GjfaxDialog create() {
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			final GjfaxDialog dialog = new GjfaxDialog(context, R.style.CommonDialog);
