package com.gjfax.app.ui.receiver;
...
import com.gjfax.app.logic.push.PushFactory;
...
public class PushMsgReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		case PushConsts.GET_MSG_DATA:
			...
			LogUtil.d(this.toString(), "第三方回执接口调用 : " + (result ? "成功" : "失败"));

			if (payload != null) {
				String data = new String(payload);

				LogUtil.d(this.toString(), "receiver payload : " + data);

				PushFactory.getPushManager().filterPusMessage(context, data);
